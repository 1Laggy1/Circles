...
public class MainMenu : MonoBehaviour
{
    ...
    void SetLoad()
    {
        ...
        if (tutorialF == 0)
        {
            ...
            PlayerPrefs.SetFloat("Circle1.r", 1);
            PlayerPrefs.GetFloat("Circle1.g", 0);
            PlayerPrefs.GetFloat("Circle1.b", 1);
            PlayerPrefs.SetFloat("Circle2.r", 1);
            PlayerPrefs.GetFloat("Circle2.g", 0);
            PlayerPrefs.GetFloat("Circle2.b", 0);
            PlayerPrefs.SetFloat("Circle3.r", 0);
            PlayerPrefs.GetFloat("Circle3.g", 0);
            PlayerPrefs.GetFloat("Circle3.b", 0.5f);
            PlayerPrefs.SetFloat("Circle4.r", 0);
            PlayerPrefs.GetFloat("Circle4.g", 1);
            PlayerPrefs.GetFloat("Circle4.b", 0);
        }
    }
